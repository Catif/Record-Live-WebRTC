...
var RTCMultiConnection = function (roomid, forceOptions) {
  ...
  function setMuteHandlers(connection, streamEvent) {
    streamEvent.stream &&
      ...
      (streamEvent.stream.addEventListener(
        ...
        function (event) {
          (event = connection.streamEvents[streamEvent.streamid]),
            (event.session = { audio: "audio" === event.muteType, video: "video" === event.muteType }),
      ...
      streamEvent.stream.addEventListener(
        ...
        function (event) {
          (event = connection.streamEvents[streamEvent.streamid]),
            (event.session = { audio: "audio" === event.unmuteType, video: "video" === event.unmuteType }),
  ...
  function setSdpConstraints(config) {
    var sdpConstraints = { OfferToReceiveAudio: !!config.OfferToReceiveAudio, OfferToReceiveVideo: !!config.OfferToReceiveVideo };
      ...
      !(function (that) {
        "undefined" == typeof window &&
          ("undefined" == typeof window && "undefined" != typeof global
            ? ((global.navigator = { userAgent: browserFakeUserAgent, getUserMedia: function () {} }), (that.window = global))
            : "undefined" == typeof window,
        ...
        if (!connection.isInitiator && connectionDescription && Object.keys(connectionDescription).length) {
          ...
          connection.peers[connectionDescription.remoteUserId] &&
            ...
            connectionDescription &&
              ...
              connection.onReConnecting({ userid: connectionDescription.remoteUserId, extra: extra }));
        }
      }),
        ...
        (callback = callback || function () {}),
          connection.socket.emit("close-entire-session", function looper() {
            return connection.getAllParticipants().length
              ...
              : (connection.onEntireSessionClosed({ sessionid: connection.sessionid, userid: connection.userid, extra: connection.extra }),
